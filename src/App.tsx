  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="stores/:id/foods"
          element={<Protector component={<Stores />} />}
        />
        <Route
          path="histories"
          element={<Protector component={<Histories />} />}
        />
        <Route
          path="stores"
          element={<Protector component={<ListStore />} />}
        />
        <Route path="profile" element={<Protector component={<Profile />} />} />
        <Route path="orders" element={<Protector component={<Orders />} />} />
        <Route
          path="stores/:id/foods/:id"
          element={<Protector component={<Foods />} />}
        />
        <Route
          path="orders/:id"
          element={<Protector component={<OrderDetail />} />}
        />
        <Route
          path="orders/:id/foods/:id"
          element={<Protector component={<FoodOrder />} />}
        />
      </Routes>
    </div>
  );
