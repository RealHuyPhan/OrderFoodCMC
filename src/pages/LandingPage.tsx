                    ...
                    <div className="w-full relative flex h-full items-center pl-9">
                      <div className=" p-[30px] relative w-full flex-wrap">
                        ...
                        <div className="text-white font-extralight text-lg my-2">
                          Chỉ cần ngồi một chỗ, bạn có thể đặt cơm từ trước mà
                          không cần phải hỏi: Hôm nay ăn gì?
                        </div>
                        <div>
                          <PrimaryButton
                            width={105}
            ...
            <div className="flex items-center justify-center w-full">
              <div className="w-1/2 flex items-center justify-center text-center">
                <p className="text-slate-600">
                  Chúng tôi sẽ cập nhật các cửa hàng và đồ ăn hàng ngày, ai cũng
                  có thể vote để chọn đồ ăn, tránh ăn những đồ ăn mà mình không
                  thích trong hôm đó.
                </p>
              </div>
            </div>
