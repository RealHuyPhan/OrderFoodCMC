...
export default function Foods() {
    ...
    const [food,setFoods] =useState<IFood>();
    ...
    const getFoods = () =>{
            axios.get(`http://localhost:1337/api/foods/${id}?populate=*`,{
                headers: {
                ...
                <div className='w-full'>
                    <div className='flex'>
                        <div className='flex-1 justify-center flex'>
                            {food.attributes.foodImage.data.map(((fi) => {
                                return <img key={fi.id}
                                src={`http://localhost:1337${fi.attributes.url}`}
                                alt="food image"
                                className='w-96' />
                            }))}
