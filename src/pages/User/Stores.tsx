...
export default function Stores() {
  ...
  useEffect(() => {
    const getStore = () => {
      axios
        .get(
          `http://localhost:1337/api/stores/${id}?populate[0]=image&populate[1]=foods.foodImage`,
          {
            headers: {
              Authorization: `Bearer ${jwt}`,
            },
      ...
      <div className="mt-28 relative">
        <div className="w-full">
          <div className="flex">
            ...
            <div className="flex-1">
              ...
              <button onClick={toggleModal} className="underline">
                Thêm cửa hàng vào đơn hàng
              </button>
              <br />
              <br />
              <button
                className="w-24 h-8 font-bold text-sm bg-gray-600 text-white border-[1px] rounded-full hover:text-gray-600 hover:bg-white"
              >
                Vote
              </button>
              {modal && (
                  ...
                  <div className="overlay">
                    <div className="modal-content">
                      ...
                      <form className="w-full" onSubmit={handleSubmit}>
                        ...
                        <p className="mt-5">
                          Xác nhận thêm bánh mì ông gì đó vào cửa hàng
                        </p>
                        <div className="flex w-full justify-center ">
                          <button
                            type="submit"
          ...
          <div className="flex items-center">
            <h2 className="font-semibold ml-5 mt-5">
              Các món ăn trong cửa hàng:
            </h2>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="ml-5">
              <h3 className="font-medium text-lg">
                {food.attributes.foodName}
              </h3>
              <p className="text-xs">Cách đây 0.6km</p>
              <div>Component star reate</div>
            </div>
          </Link>
        ))}
      </div>
